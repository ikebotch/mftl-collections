...
namespace MFTL.Collections.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260430214926_RepairOutboxMessagesPayloadJsonSchema")]
    partial class RepairOutboxMessagesPayloadJsonSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MFTL.Collections.Domain.Entities.CollectorPin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MFTL.Collections.Domain.Entities.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MFTL.Collections.Domain.Entities.ProcessedExternalPaymentCallback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PaymentServicePaymentId")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("PaymentServicePaymentId");

                    b.ToTable("ProcessedExternalPaymentCallbacks");
                });
            ...
            modelBuilder.Entity("MFTL.Collections.Domain.Entities.RolePermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
